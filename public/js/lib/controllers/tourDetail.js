...
tourDetail.controller('tourDetail', ['$scope', 'searchData', 'tourData', 'purchaseData', 'tourValuationRs', 'travelPackD', 'serviceAdd','$http', '$location', 'currencyData', '$window', function($scope, searchData, tourData, purchaseData, tourValuationRs, travelPackD, serviceAdd, $http, $location, currencyData, $window) {
