...
<html ng-app="getcentre">
	...
	<body>
		<div class="booke-area" ng-controller="mainController">
			<div>
				<div class="col-md-3 socials cage">
				...
				<div class="col-md-4 cage reach">
					<p>9am-6pm</p>
					<p>+234 8188009911</br>+234 012916333</p>
				</div>
				<div class="col-md-4 col-xs-pull-12 cage identity">
					<a href="#/"><img src="img/Logo.png" /></a>
				</div>
				<div class="col-md-3 cage user-bag">
				...
				<div class="col-md-4 cage searches">
				...
				<div class="col-md-18 no-padding booking-e" ng-init="initSearch()">
					...
					<div class="tab-below hideMe" id="searchMachine" ng-show="search">
						<div ng-if="defaultSearch.module!='Visa' && defaultSearch.module!='Insurance'">
							...
							<div class="col-md-18 trip-type booking-form" ng-show="searchInit" ng-if="defaultSearch.moduleType!='regular'">
							...
							<div ng-repeat="input in defaultSearch.moduleCurrType" ng-if="input!=''" ng-class="formPosition(input)">
								<div class="going booking-form"  ng-if="input.type=='place' && !(input | isArray) && (input.name=='From' || input.name=='Destination' || searchInit)">
									<label ng-bind="input.name"></label>
								...
								<div class="col-md-18 booking-form no-padding"  ng-if="input.type=='occupancy' && !(input | isArray) && searchInit">
									<div class="col-md-9" ng-repeat="guest in input.subtypes">
										<div class="col-md-18 people-side">
											<div class="col-md-6 increaser">
												<p class="plus" ng-click="addOccupancy(guest)">+</p>
												<p class="plus" ng-click="takeOccupancy(guest)">-</p>
											</div>

											<div class="col-md-6 anum"><p class="apush" ng-bind="guest.value | custNo"></p></div>
											<div class="col-md-6"><p class="apush" ng-bind="guest.name"></p></div>
										</div>
										<div class="col-md-18 nopadding" ng-if="guest.name=='Child' && guest.ages.length > 0">
											<div class="col-md-18 nopadding" ng-repeat="childAge in guest.ages">
								...
								<div class="col-md-18 booking-form no-padding"  ng-if="input.type=='room' && !(input | isArray) && searchInit">
									<div class="col-md-18 people-side">
										<div class="col-md-6 increaser">
										...
										<div class="col-md-6 anum"><p class="apush" ng-bind="input.value | custNo"></p></div>
										<div class="col-md-6"><p class="apush" ng-bind="input.name">Rooms</p></div>
									</div>
								</div>

								<!-- <div class="col-md-2 arrow booking-form no-padding"  ng-if=" input.type=='date' && input.subType=='todate' && !(input | isArray)">&rarr;</div> -->
								<div class="col-md-18 booking-form bookingFormInput no-padding" ng-init="setDates(input)"  ng-if="input.type=='date' && !(input | isArray)">
								...
								<div ng-if="input | isArray" class="col-md-18">
									<div ng-repeat="inp in input track by $index" class="col-md-18">
										<div  ng-repeat="form in inp track by $index" ng-class="formPosition(form, input)">
											<div class="col-md-18 going booking-form"  ng-if="form.type=='place'" ng-show="form.name=='From' || searchInit" >
											...
											<div class="col-md-18 bookingFormInput booking-form no-padding " ng-init="setDates(form)"  ng-if="form.type=='date'">
												<input type="text" ng-if="form.subType=='fromdate'" id="dateFrom" data="{{form}}"  name="{{$parent.$parent.$parent.$index}}" class="fromdate datePickerDummy" date-from />
												<div class="dateContainer" ng-if="form.subType=='fromdate'" >
													<div class="dateBreaker rborder" ng-click="setFromDate(0)" ng-bind="form.value.day"></div>
													<div class="dateBreaker rborder" ng-click="setFromDate(0)" ng-bind="form.value.month"></div>
													<div class="dateBreaker rborder" ng-click="setFromDate(0)" ng-bind="form.value.year"></div>
													<div class="iconContainer" ng-click="setFromDate(0)"><span  class="iconCalendar"></span></div>
												</div>
											</div>
											<div class="col-md-18 booking-form no-padding"  ng-if="form.type=='guest' && searchInit ">
												<div class="col-md-18 people-side">
													<div class="col-md-6 increaser">
													...
													<div class="col-md-6 anum"><p class="apush" ng-bind="form.value | custNo"></p></div>
													<div class="col-md-6"><p class="apush" ng-bind="form.name"></p></div>
												</div>
												<div class="col-md-18 nopadding" ng-if="form.name=='Child' && form.ages.length > 0">
													<div class="col-md-18 nopadding" ng-repeat="childAge in form.ages">
								                    	<span class="col-xs-18 nopadding child_select"><label>Child {{$index+1}}</label></span>
								                        <div class="get_input col-xs-18">
								                        	<input type="text" ng-model="childAge.value" class="form-control trans_input_sm input-sm" placeholder="Date of Birth" birth-dchild >
								                        </div>
							...
							<div ng-repeat="input in defaultSearch.others" class="col-md-6 booking-form" ng-show="searchInit">
				                <div class="col-md-18" ng-if="input.type=='select'" name="{{input.name}}">
				                    <label ng-bind="input.name" class="col-md-8 no-padding"></label>
				                    <div class="bookingFormInput col-md-9">
							...
							<div class="col-md-3 no-padding pull-right booking-form sButAlign">
						...
						<div ng-show="defaultSearch.module=='Visa'">
							<visa-engine class="col-md-18 no-padding" ng-show="defaultSearch.module=='Visa'"  ng-controller="otherPages"></visa-engine>
						</div>
						<div ng-show="defaultSearch.module=='Insurance'">
							<insurance-engine class="col-md-18 no-padding" ng-show="defaultSearch.module=='Insurance'"  ng-controller="otherPages"></insurance-engine>
						</div>
					</div>
				</div>
			</div>
